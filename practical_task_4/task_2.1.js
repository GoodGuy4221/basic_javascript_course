...
let instance = new AttachedPost('Greg', 'lorem', '2021-09-24');
console.log(`${instance.author}\n${instance.text}\n${instance.date}\n${instance.highlighted}`)
instance.edit('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam eum quia quidem.');
instance.makeTextHighlighted();
